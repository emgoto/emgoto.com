---
title: "Analyze your React app’s bundle size and reduce it using code-splitting"
date: 2020-01-10
updated: 2020-11-22
tags: ["react"]
emoji: ✂️
coverImage: 'https://images.unsplash.com/photo-1586685983389-612a65517b38?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80'
--- 
...
![A React app's bundle size in the network tab](initial_network_tab.png)
...
![ccreate-react-app initial bundle size](initial_react_dom.png)
...
![create-react-app bundle size with react-charts included](adding_charts.png)
...
![React bundle split into two using code-splitting](splitting_charts.png)
...
![Split bundle visible in the network tab](splitting_network_tab.png)
...
And there you have it! To learn more about code-splitting, the React docs provide [a great guide on it](https://reactjs.org/docs/code-splitting.html) which I’d recommend checking out.
