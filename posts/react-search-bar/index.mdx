...
<Gif src="/react-search-bar/example.gif" alt="GIF of posts being filtered as user types query in search box"/>
...
<Gif src="/react-search-bar/navigation.gif" alt="GIF of User typing in search query, clicking search button and navigation occurring" />
