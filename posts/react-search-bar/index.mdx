...
!['Search bar with label and placeholder saying "Search blog posts"'](./with-label.png)
...
We should also add a test for the functionality of your component. Let’s add one that tests that when you type “preact”, that it only shows one post:
