...
<Seo title="Gaming Backlog" slug='gaming-backlog' description='Gaming Backlog allows you to connect to your Steam account and easily bulk-add games as cards to your Trello board'/>
...
[Setting up Steam Authentication using OpenID](/steam-auth-and-openid/).
